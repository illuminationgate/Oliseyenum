    ...
    <div class="header-upper">
      <div class="container">
        <div class="header-inner d-flex align-items-center">
          ...
          <div class="menu-btns">
            <NuxtLink to="/contact" class="theme-btn contact-btn bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-full transition-colors">Hire Me<i class="ri-shake-hands-line"></i></NuxtLink>
          </div>
        </div>
      </div>
    </div>
